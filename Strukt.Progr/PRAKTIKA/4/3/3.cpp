...
void showTrains(TRAIN* trains, int trainCnt){
/*
...
void sortList(TRAIN* train, int trainCnt){
/*
...
void trainsMenu(TRAIN *train, int trainCnt){
/*
...
int main(){
    ...
    int trainCnt = 8; // traukinių skaičius

    TRAIN *tr = new TRAIN[trainCnt]; // .h faile
    cout << endl;

    INIT(tr, trainCnt); // bus sukurtas traukinių masyvas. Nenurodžius 'true' masyvas bus sukurtas automatiškai.
//a)
